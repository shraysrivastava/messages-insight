...
CHECKS = [
    ...
    (2, "S2.3", "join code enforced",                  lambda: _grep("app/main.py", r"code")),
    (2, "S2.4", "client-timestamped answers",          lambda: _grep("poc/static/shared.js", r"clientTime|sentAt") or _grep("app/main.py", r"client_time")),
    (2, "S2.5", "websocket heartbeat",                 lambda: _grep("app/main.py", r"ping|heartbeat")),
